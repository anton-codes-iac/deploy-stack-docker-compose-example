# deploy-stack-docker-compose-example - Cloud Infrastructure
...
* **Ruby on Rails:** Bound automatically by the CLI's Puma command (`-b tcp://0.0.0.0:8080`).
* **Django:** Bound automatically by the CLI's Gunicorn command (`--bind 0.0.0.0:8080`).
