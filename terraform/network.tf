...
resource "aws_vpc" "main" {
  ...
  tags = {
    Name = "deploy-stack-docker-compose-example-vpc"
  }
}
...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name = "deploy-stack-docker-compose-example-public-subnet-${count.index + 1}"
  }
}
...
resource "aws_security_group" "alb" {
  name        = "deploy-stack-docker-compose-example-alb-sg"
...
resource "aws_security_group" "ecs_tasks" {
  name        = "deploy-stack-docker-compose-example-ecs-sg"
